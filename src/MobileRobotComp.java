...
/*!
 * @class MobileRobotComp
 * @brief Standalone component Class
 *
 */
public class MobileRobotComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(MobileRobot.component_conf);
      mgr.registerFactory(prop, new MobileRobot(), new MobileRobot());

      // Create a component
      RTObject_impl comp = mgr.createComponent("MobileRobot");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        MobileRobotComp init = new MobileRobotComp();
